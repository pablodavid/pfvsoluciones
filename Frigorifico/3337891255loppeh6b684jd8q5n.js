...
var Funcionarios = [
	...
	{nombre: 'Angela+Sandoval', rut: '19198300-9', empresa: m, area: As},
	...
	{nombre: 'Cristobal+Neculman', rut: '19480812-7', empresa: l, area: s},
	{nombre: 'Mauricio Manqueche', rut: '9515755-6', empresa: l, area: f},
	{nombre: 'Peterson+Charles', rut: '26847786-1', empresa: f, area: 'Corrales'},
	{nombre: 'Sergio+Sayago', rut: '6572992-K', empresa: 'SAG', area: 'Medico+Veterinario'},
	{nombre: 'Ivan+Fredericksen', rut: '19197487-5', empresa: f, area: se},
	{nombre: 'Jonathan+Hermosilla', rut: '17262840-0', empresa: l, area: 'Trafico+Cajas'},
	{nombre: 'Jose+Correa', rut: '17933975-7', empresa: f, area: d},
	{nombre: 'Andres+Muñis', rut: '23745842-7', empresa: f, area: fa},
	{nombre: 'Cristina+Caniupan', rut: '16843760-9', empresa: o, area: 'Calidad'},
	{nombre: 'Claudio+Acuña', rut: '12021454-3', empresa: l, area: fa},
	{nombre: 'Ivan+Rosales', rut: '20103049-8', empresa: f, area: d},
	{nombre: 'Pablo+Velasquez', rut: '19218221-2', empresa: f, area: fa},
	{nombre: 'Yoselyn+Cheuquelaf', rut: '18333388-7', empresa: l, area: d},
	{nombre: 'Jose+hernandez', rut: '12089434-K', empresa: f, area: fa},
	{nombre: 'Carlos+Castillo', rut: '10833213-1', empresa: o, area: tr},
	{nombre: 'Sergio+Chandia', rut: '16948388-4', empresa: f, area: d},
	{nombre: 'Sergio+Mendez', rut: '19175477-8', empresa: g, area: t},
	{nombre: 'Lorena+Moraga', rut: '16125649-8', empresa: f, area: 'RRHH'},
	{nombre: 'Ricardo+Ñancucheo', rut: '18728651-4', empresa: f, area: d},
	{nombre: 'Alejandro+Ñeculñir', rut: '11303607-K', empresa: f, area: e},
	{nombre: 'Mario+Maricura', rut: '19792218-4', empresa: f, area: d},
	{nombre: 'Roberto+Lapier', rut: '19094134-5', empresa: f, area: d},
	{nombre: 'Jose+Arevalo', rut: '6900066-5', empresa: o, area: tr},
	{nombre: 'Sixto+Huenchun', rut: '18901579-8', empresa: f, area: ma},
	{nombre: 'Luis+Fernandez', rut: '12890670-3', empresa: l, area: s},
	{nombre: 'Lautaro+Cidiaco', rut: '10195034-4', empresa: f, area: fa},
	...
	{nombre: 'Eladio+Gutierrez', rut: '16533477-7', empresa: f, area: fa},
	{nombre: 'Samuel+Manquel', rut: '17882116-4', empresa: f, area: fa},
	{nombre: 'Denisse+Malledo', rut: '18874274-2', empresa: f, area: p},
	{nombre: 'Rene+Morales', rut: '12928908-2', empresa: f, area: 'Ganaderia'},
	{nombre: 'Hernaldo+Vazquez', rut: '17583272-6', empresa: f, area: fa},
	{nombre: 'Gonzalo+Uribe', rut: '13128722-4', empresa: f, area: d},
	{nombre: 'Saintalais+Destine', rut: '25405198-5', empresa: f, area: fa},
	{nombre: 'Mayderson+Lormand', rut: '25872177-2', empresa: f, area: fa},
	{nombre: 'Sadrack+Pierre', rut: '25505948-1', empresa: m, area: fa},
	{nombre: 'Roberto+Leal', rut: '14188496-4', empresa: o, area: tr},
	{nombre: 'Fabian+Araos', rut: '14139094-5', empresa: o, area: tr},
	{nombre: 'Maciel+Zamorano', rut: '19917916-0', empresa: f, area: fa},
	{nombre: 'Silvia+Prieto', rut: '10591571-3', empresa: f, area: fa},
	...
	{nombre: 'Viviana+Galindo', rut: '19762055-2', empresa: m, area: As},
	{nombre: 'Alberto+Sandoval', rut: '13964166-3', empresa: f, area: fa},
	{nombre: 'Fabiola+Gonzales', rut: '19554636-9', empresa: f, area: fa},
	{nombre: 'Victor+Opazo', rut: '20952295-0', empresa: l, area: fa},
	{nombre: 'Hector+Ruiz', rut: '15584015-3', empresa: m, area: fa},
	{nombre: 'Sergio+Caniuqueo', rut: '11686509-2', empresa: f, area: fa},
